...
VIDEO_URL = "https://youtube.com/shorts/USc22MHu9cU?feature=share" #replace with required youtube shorts
...
def click_comment():
    try:
        button = driver.find_element(By.CSS_SELECTOR, '#comments-button > ytd-button-renderer > yt-button-shape > label > button > yt-touch-feedback-shape > div > div.yt-spec-touch-feedback-shape__fill') #pause the yt shorts
        button.click()
    except NoSuchElementException:
        print("click on comment box not found.")
    time.sleep(2)
